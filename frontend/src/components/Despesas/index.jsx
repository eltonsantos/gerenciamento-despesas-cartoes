import { Box, Typography, Paper, Table, TableBody, TableCell, TableContainer, TableFooter, TableHead, TableRow, Button } from '@mui/material';
...
export default function Despesas({ tabValue }) {
  ...
  return (
    <Box>
      ...
      {tabValue === 1 && (
        <Typography>Conteúdo Arquivado de Despesas</Typography>
      )}
    </Box>
  );
}
